// frontend/src/components/Admin/ReportForm/ReportForm.jsx
...
export default function ReportForm({ onCreateSuccess, initialData }) {
  ...
  // Image toolbar logic (can be extracted if used in multiple forms)
  const hideToolbar = () => {
  ...
  return (
    <>
      ...
      <ImageToolbar
        ...
        selectedSides={new Set(['all'])} // Optional: add side toggles later
        onAction={() => {}} // Optional: reuse full image margin logic if needed
      />
