...
export default function ImageToolbar({ selectedImgRef, toolbarRef, selectedSides, setSelectedSides, onAction }) {
  ...
  return (
    <div ref={toolbarRef} className={styles.toolbar}>
      ...
      <button onClick={() => onAction('increase-margin')} title="Increase margin">➕</button>
      <button onClick={() => onAction('decrease-margin')} title="Decrease margin">➖</button>
      <button onClick={() => onAction('align-left')} title="Align Left">▌</button>
      <button onClick={() => onAction('align-right')} title="Align Right">▐</button>
      <button onClick={() => onAction('reset-styles')} title="Reset styles">⟲</button>
    </div>
  );
}
